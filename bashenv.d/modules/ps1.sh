...
PS1='[${debian_chroot:+($debian_chroot)}$(RC=$?;GREEN="\[\033[0;32m\]";RED="\[\033[0;31m\]";[ $RC -eq 0 ] && echo ${GREEN} || echo "${RED} ${RC} ")@\h\[\033[00m\]:\[\033[00;90m\]${VIRTUAL_ENV:+(}\W$(BRANCH=$(__ps1_git);echo "${BRANCH:+ $BRANCH}")${VIRTUAL_ENV:+)}\[\033[00m\]]\$ '
